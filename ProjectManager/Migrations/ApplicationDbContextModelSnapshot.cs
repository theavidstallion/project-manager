...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProjectManager.Models.ActivityLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ProjectManager.Models.Tag", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ProjectManager.Models.TaskTag", b =>
                {
            ...
            modelBuilder.Entity("ProjectManager.Models.Project", b =>
                {
                    b.HasOne("ProjectManager.Models.ApplicationUser", "Creator")
                        .WithMany()
            ...
            modelBuilder.Entity("ProjectManager.Models.ProjectTask", b =>
                {
                    b.HasOne("ProjectManager.Models.ApplicationUser", "AssignedUser")
                        .WithMany("Tasks")
            ...
            modelBuilder.Entity("ProjectManager.Models.TaskTag", b =>
                {
                    b.HasOne("ProjectManager.Models.Tag", "Tag")
                        .WithMany("TaskTags")
                        .HasForeignKey("TagId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
