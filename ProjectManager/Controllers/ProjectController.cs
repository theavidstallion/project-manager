...
namespace ProjectManager.Controllers
{
    ...
    public class ProjectController : ControllerBase
    {
        ...
        public async Task<IActionResult> DeleteProject(int id) 
        {
            ...
            // Assuming Task.Status is "Open" or "InProgress" for unfinished tasks.
            ...
            else if (User.IsInRole("Manager"))
            {
                ...
                {
                    return Forbid("Managers can only delete projects they manage/created.");
                }
            }
            else
            {
        ...
        public async Task<IActionResult> AssignUserToProject (int id, [FromBody] ProjectMemberDto model)
        {
            ...
            else if (User.IsInRole("Manager"))
            {
                ...
                {
                    return Forbid("Managers can only assign users to projects they manage/created.");
                }
            }
            else
            {
                return Forbid("Only Admins and Managers can assign users to projects.");
            }
        ...
        public async Task<IActionResult> EditProject(int id, [FromBody] EditProjectDto model)
        {
            ...
            else if (User.IsInRole("Manager"))
            {
                ...
                if (project.CreatorId != currentUserId)
                {
                    return Forbid("Managers can only edit projects they manage/created.");
                }
            }
            else
            {
                return Forbid("Only Admins and Managers can edit projects.");
            }
        ...
        public async Task<IActionResult> AddMemberToProject(int id, [FromBody] ProjectMemberDto model)
        {
            ...
            else if (User.IsInRole("Manager"))
            {
                ...
                if (project.CreatorId != currentUserId)
                {
                    return Forbid("Managers can only add members to projects they manage/created.");
                }
            }
            else
            {
                return Forbid("Only Admins and Managers can add members to projects.");
            }
            var projectUser = new ProjectUser
            {
                UserId = model.UserId,
        ...
        public async Task<IActionResult> RemoveMemberFromProject(int id, string userId)
        {
            ...
            else if (User.IsInRole("Manager"))
            {
                ...
                if (project.CreatorId != currentUserId)
                {
                    return Forbid("Managers can only remove members from projects they manage/created.");
                }
            }
            else
            {
                return Forbid("Only Admins and Managers can remove members from projects.");
            }
        ...
        public async Task<IActionResult> RemoveMember(int projectId, string userId)
        {
            ...
            {
                return Forbid("Only the Project Manager or Admin can remove members.");
            }
